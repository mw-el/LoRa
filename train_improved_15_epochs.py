...
try:
    ...
    print(f"  Epochs: 15 (comprehensive training with captions)")
    ...
    print("=" * 80)
    print("STARTING IMPROVED TRAINING WITH 15 EPOCHS...")
    print("=" * 80 + "\n")

    # Run training with captions, higher rank, and 15 epochs
    result = train_lora(
        base_model=str(BASE_MODEL),
        model_type="sd15",
        image_dir=SOURCES_DIR,
        output_dir=OUTPUT_DIR,
        style_token="eudes-correia-v2",  # v2 for improved version
        use_captions=True,  # ← USE CAPTIONS
        resolution=768,
        lora_rank=64,  # ← INCREASED from 32
        learning_rate=1e-4,
        num_epochs=15,  # ← 15 EPOCHS FOR BETTER LEARNING
        batch_size=1,
    ...
    print("✓ 15 epochs training (was 10)")
    print("✓ Better model capacity + deeper learning")
    ...
    print("  • More refined Eudes Correia watercolor style")
    print("=" * 80)
